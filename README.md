...
- **[Локальный запуск](LOCAL_SETUP.md)** — Пошаговая инструкция для разработкиЫ
...
### 4. Покрытие кода
```
Input: https://github.com/AIra-work213/SpbTechHack
Output:
 - Детальный отчет по всему репозиторию с вомознжостью генерации тестов для непокрытых функций
```
...
Садовой Денис, Зекин Владлен, Тихонова Роза, Бовина Полина
